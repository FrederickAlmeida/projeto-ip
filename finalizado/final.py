...
class item_modificador_vida(pygame.sprite.Sprite):
    def __init__(self, nome, dano, x, y):
        self.nome = nome
        self.dano = dano
...
class personagens(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.atual = 0
        self.image = self.sprites[self.atual]
        self.image = pygame.transform.scale(self.image, (131/7, 136/7))
...
armadilha1 = item_modificador_vida('armadilha', 1, 100, 35)
armadilha2 = item_modificador_vida('armadilha', 1, 380, 75)
armadilha3 = item_modificador_vida('armadilha', 1, 160, 275)
armadilha4 = item_modificador_vida('armadilha', 1, 420, 530)
armadilha5 = item_modificador_vida('armadilha', 1, 535, 270)
...
pocao1 = item_modificador_vida('pocao',1,  30, 90)  
pocao2 = item_modificador_vida('pocao',1,  125, 380)
pocao3 = item_modificador_vida('pocao',1,  488, 450)
...
fragmento1 = item('fragmento1', 470, 7)
fragmento2 = item('fragmento2', 430, 230)
fragmento3 = item('fragmento2', 120, 550)
...
while True:
    ...
    barradevida = pygame.draw.rect(tela, (255, 0, 0), (20, 20, (personagem.vidadesejada/personagem.vidamaxima)*100,5))
    molduraemsi = pygame.draw.rect(tela, (255, 255, 255), (20, 20, moldura, 5), 1)
    ...
    if personagem.vida > personagem.vidadesejada:
        ...
        if personagem.vida == 0 or personagem.vidadesejada == 0:
            ...
            janela = int(((personagem.vidadesejada - personagem.vida)/(personagem.vidadesejada/personagem.vidamaxima)))
            janelacor = (255, 255, 0)
    barraanimada = pygame.Rect(10, 45, (personagem.vida/personagem.vidamaxima)*100, 5)
    transicaobarra = pygame.Rect(barraanimada.right, 45, janela, 5)
    pygame.draw.rect(tela, (255,0,0) , barraanimada)
    pygame.draw.rect(tela, janelacor , transicaobarra)
    molduraemsi = pygame.draw.rect(tela, (255, 255, 255), (10, 45, 100, 5), 1)
    lista_linhas = []
